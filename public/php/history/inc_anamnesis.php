...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           SKIN         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}} -->
          <div class="pt_10 col s4">
            ...
            <div class="col s12 history_filter">
              <input id="txt_ef_filter_skin" type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('skin',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           HEAD         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4">
            ...
            <div class="col s12 history_filter">
              <input id="txt_ef_filter_head" type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('head',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           ORL         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('orl',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           CUELLO         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('neck',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           RESPIRATORY         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4 l3">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('respiratory',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           CARDIAC         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4 l3">
            <span class="font_bolder">Card&iacute;aco</span>
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('cardiac',this.value);">
            </div>
...
<!-- {{-- @@@@@@@@@@@@@@@@@@@@@@           AUSCULTATION         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4 l2">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('auscultation',this.value);">
            </div>
...
<!--  {{-- @@@@@@@@@@@@@@@@@@@@@@           INSPECTION         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4 l2">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('inspection',this.value);">
            </div>
...
<!--  {{-- @@@@@@@@@@@@@@@@@@@@@@           PALPATIONS        @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4 l2">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('palpation',this.value);">
            </div>
...
<!--  {{-- @@@@@@@@@@@@@@@@@@@@@@           PELVIS         @@@@@@@@@@@@@@@@@@@@@@@@@@    --}}  -->
          <div class="pt_10 col s4">
            ...
            <div class="col s12 history_filter">
              <input type="text" class="h_30" placeholder="Buscar..." onkeyup="cls_examination.ef_filter_list('hip',this.value);">
            </div>
